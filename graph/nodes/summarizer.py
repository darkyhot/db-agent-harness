...
class SummarizerNodes:
    ...
    def _get_summarizer_system_prompt(self) -> str:
        ...
        return (
            ...
            "- ЗАПРЕЩЕНО генерировать новый SQL в ответе. Показывай ТОЛЬКО SQL из блока "
            "«Результаты инструментов». Если выполненных запросов нет или их результат "
            "не отвечает на вопрос — явно напиши: «Данных недостаточно, требуется "
